...
const blogCards: BlogCardData[] = [
  {
    id: 1,
    src: "https://mcp.camel-ai.org/camel-ai-agent-mcp-integration.png",
  ...
  {
    id: 2,
    src: "https://mcp.camel-ai.org/connect-your-owl-agent-to-notion-via-the-mcp-server.png",
  ...
  {
    id: 3,
    src: "https://mcp.camel-ai.org/camel-mcp-servers-model-context-protocol-ai-agents.png",
